...
export type ManufacturerModel =
  runtime.Types.Result.DefaultSelection<Prisma.$ManufacturerPayload>;
...
export type GetManufacturerGroupByPayload<T extends ManufacturerGroupByArgs> =
...
export type ManufacturerScalarWhereWithAggregatesInput = {
  ...
  country?:
    | Prisma.StringNullableWithAggregatesFilter<"Manufacturer">
    | string
    | null;
};
...
export type ManufacturerGetPayload<
  S extends boolean | null | undefined | ManufacturerDefaultArgs,
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, ManufacturerGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetManufacturerGroupByPayload<T>
...
> = {
   ...
   */
  distinct?:
    | Prisma.ManufacturerScalarFieldEnum
    | Prisma.ManufacturerScalarFieldEnum[];
};
...
> = {
   ...
   */
  data:
    | Prisma.ManufacturerCreateManyInput
    | Prisma.ManufacturerCreateManyInput[];
...
> = {
   ...
   */
  data: Prisma.XOR<
    Prisma.ManufacturerUpdateInput,
